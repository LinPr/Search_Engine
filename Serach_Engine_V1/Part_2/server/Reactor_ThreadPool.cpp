...
Reactor_ThreadPool::Reactor_ThreadPool(size_t threadNum, size_t queSize, const std::string ip, unsigned short port, std::string dictionaryPath, std::string dictionaryIndexPath)
...
void Reactor_ThreadPool::Message(const TcpConnectionPtr & pconnection_manager)
{
    ...
    Task task(msg, pconnection_manager, _dictionary);
